...
** <code>QPI Link Frequency Select [Auto ?–> 8.0 GT/s]</code>: another Vudu parameter worth further investigating, there is no clear “higher is better” as it seems to depend on other CPU parameters e.g. voltage, overclocking etc. 
