...
* <code>WHEA Configuration –> WHEA Support [Enabled –> Disabled]</code>: Windows Hardware Error Architecture support, irrelevant, we use Ubuntu. 
* <code>Onboard LAN Configuration –> Intel W82574L OpROM1 [PXE –> iSCSI]</code>: TODO try the setting iSCSI for improved LAN performance (not sure yet whether this will increase the LAN speed to 1000 MB/s) 
